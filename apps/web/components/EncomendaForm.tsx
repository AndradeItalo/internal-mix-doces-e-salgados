...
export function EncomendaForm({ encomendaId, onBack }: EncomendaFormProps) {
    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        <h1 className="text-gray-900 mb-2">
          {encomendaId ? 'Editar Encomenda' : 'Nova Encomenda'}
        </h1>
        <p className="text-gray-600">
          {encomendaId ? 'Atualize as informações da encomenda' : 'Crie uma nova encomenda'}
        </p>
      </div>
