...
export function Pagamentos() {
  ...
  // Pagamentos atrasados (entregas passadas com saldo pendente)
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      <p className={`${
                        pagamento.status === 'recebido' ? 'text-green-700' :
                        pagamento.status === 'atrasado' ? 'text-red-700' :
                        'text-orange-700'
                      }`}>
                        R$ {pagamento.valor.toFixed(2)}
                      </p>
                      <span className={`inline-block mt-1 px-2 py-1 rounded text-white ${
                        pagamento.status === 'recebido' ? 'bg-green-500' :
                        pagamento.status === 'atrasado' ? 'bg-red-500' :
                        'bg-orange-500'
                      }`}>
                        {pagamento.status === 'recebido' ? 'Recebido' :
